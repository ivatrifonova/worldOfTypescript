...
class Show {
public showUnits(team: string): string {
    const teamUnits = engine.units.filter(unit => team.toLowerCase() === unit.team.toLowerCase());
...
public showCoordinates(coordinates: string):string{
